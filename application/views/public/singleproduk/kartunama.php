         ...
         <div class="row">
            ...
            <div class="col">
               <div id="description" class="tabs tabs-simple tabs-simple-full-width-line tabs-product tabs-dark mb-2">
                  ...
                  <?php foreach ($detailkartu as $info) : ?>
            ...
            <div class="col-md-7">
            <?php foreach ($detailkartu as $data) : ?>
               <div class="summary entry-summary position-relative">                

                  <h1 class="mb-0 font-weight-bold text-7"><?php echo $data->name; ?></h1>                  
                  <form enctype="multipart/form-data" method="post" class="cart" action="<?php echo base_url('Cart/addkartunama'); ?>">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-7">
                        <select class="form-control" id="bahankartu" name="bahankartu" required oninvalid="this.setCustomValidity('Mohon pilih bahan kartu')" oninput="setCustomValidity('')" onchange="calculateprice()">
                  ...
                  <div class="form-group row">
                     <label class="col-lg-3 control-label text-lg-start pt-2">Pilih 1 muka/ 2 muka</label>
                     <div class="col-lg-7">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-7">
                        <select class="form-control" id="jenisfinishing" name="jenisfinishing" required oninvalid="this.setCustomValidity('Mohon pilih Jenis Potong')" oninput="setCustomValidity('')" onchange="calculateprice()">
...
<script>   
   ...
   function calculateprice() {
      ...
      var pricedefault = $('#bahankartu').find(':selected').data('bahan');
