      ...
      <div class="container">
         <div class="row">
            <div class="col-md-12 align-self-center p-static order-2 text-center">
               <h1 class="font-weight-bold text-dark">Standing Banner</h1>
            </div>
            <div class="col-md-12 align-self-center order-1">
               <ul class="breadcrumb d-block text-center">
                  <li><a href="#">Beranda</a></li>
                  <li class="active">Standing Banner</li>
               </ul>
            </div>
         </div>
      </div>
         ...
         <div class="row">
            ...
            <div class="col">
               <div id="description" class="tabs tabs-simple tabs-simple-full-width-line tabs-product tabs-dark mb-2">
                  ...
                  <?php foreach ($detailstand as $info) : ?>
            ...
            <div class="col-md-7">
            <?php foreach ($detailstand as $data) : ?>
               <div class="summary entry-summary position-relative">                

                  <h1 class="mb-0 font-weight-bold text-7"><?php echo $data->name; ?></h1>                  
                  <form enctype="multipart/form-data" method="post" class="cart" action="<?php echo base_url('Cart/addstandbanner'); ?>">
                  ...
                  <span>1 Buah Tiang Y-banner Alumunium Adusjustable</span><br>
                  ...
                  <div class="form-group row">
                     ...
                     <select class="form-control" id="kualitas" name="kualitas" required oninvalid="this.setCustomValidity('Mohon pilih Kualitas Gambar')" oninput="setCustomValidity('')" onchange="calculateprice()">
                           ...
                           <option value="Resolusi Tinggi (Ecosolvent Printer)" data-kualitas="68000">Resolusi Tinggi (Ecosolvent Printer)</option>                           
                        </select>
                     </div>                     
                  </div>
                  ...
                  <div class="form-group row">
                     <label class="col-lg-3 control-label text-lg-start pt-2">Upload Gambar</label>
                     <div class="col-lg-7">
