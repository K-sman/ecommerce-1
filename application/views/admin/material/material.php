<section role="main" class="content-body card-margin">
   <header class="page-header">
      ...
      <div class="right-wrapper text-end">
         <ol class="breadcrumbs">
            ...
            <li><span>Jenis Bahan Produk</span></li>            
         </ol>
      ...
      <div class="col">
         <section class="card">
            <header class="card-header">
               ...
               <h2 class="card-title">Jenis Bahan Produk&emsp; <a class="mb-1 mt-1 me-1 modal-with-zoom-anim ws-normal btn btn-primary" href="#tambah"><i class="fas fa-plus-circle"></i> Tambah Data</a></h2>               
            </header>
            <div class="card-body">
               <table class="table table-bordered table-striped mb-0" id="datatable-default">
                  ...
                  <tbody>                     
                     ...
                     <?php foreach ($materials as $dt) : ?>
                        <tr>
                           <td><?php echo $no ?></td>                              
                           <td><?php echo $dt->material; ?></td>
                           <td><?php echo $dt->description; ?></td>
                           <td><?php echo $dt->categories; ?></td>
                           <td>Rp. <?php echo $dt->add_price; ?></td>
                           <td style="white-space: nowrap; text-align: center;"><a class="mb-1 mt-1 me-1 modal-with-zoom-anim ws-normal btn btn-success btn-sm" href="#ubah<?php echo $dt->id_material; ?>"><i class="fa fa-edit"></i></a> <a onclick="return confirm('Anda yakin menghapus data Jenis Bahan ini?');" href="<?php echo base_url("JenisBahan/delete/" . $dt->id_material); ?>" class="btn btn-danger btn-sm" title="Hapus Data Jenis Bahan"><i class="fa fa-trash"></i></a></td>
                        </tr>
                        <?php $no++; ?>
                     <?php endforeach; ?>                     
                  </tbody>
   ...
   <div id="tambah" class="zoom-anim-dialog modal-block modal-header-color modal-block-primary mfp-hide">
      <section class="card">
         <header class="card-header">
            <h2 class="card-title">Tambah Jenis Bahan Produk <a href="javascript:void(0)" class="modal-dismiss pull-right text-white">x</a></h2>
         </header>
         <form action="<?php echo base_url('JenisBahan/insert'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal mb-lg">
         <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
         <div class="card-body">
            <div class="form-group">
               <label for="inputAddress">Nama Bahan</label>
               <input type="text" class="form-control" name="material" maxlength="50" required oninvalid="this.setCustomValidity('Mohon isi Nama Bahan')" oninput="setCustomValidity('')">
            </div>
            <div class="form-group">
   ...
   <?php foreach ($materials as $up) : ?>
   <div id="ubah<?php echo $up->id_material; ?>" class="zoom-anim-dialog modal-block modal-header-color modal-block-success mfp-hide">
      <section class="card">
         <header class="card-header">
            <h2 class="card-title">Ubah Jenis Bahan Produk <a href="javascript:void(0)" class="modal-dismiss pull-right text-white">x</a></h2>
         </header>
         <form action="<?php echo base_url('JenisBahan/update'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal mb-lg">
         <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
         <div class="card-body">
            <input type="hidden" class="form-control" name="id_material" value="<?php echo $up->id_material; ?>" readonly>
            <div class="form-group">
               <label for="inputAddress">Nama Bahan</label>
               <input type="text" class="form-control" name="material" maxlength="50" value="<?php echo $up->material; ?>" required oninvalid="this.setCustomValidity('Mohon isi Nama Bahan')" oninput="setCustomValidity('')">
            </div>
            <div class="form-group">
